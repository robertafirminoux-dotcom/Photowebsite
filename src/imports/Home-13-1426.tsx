import svgPaths from "./svg-uvobuo6y1r";
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#ecebeb] content-stretch flex gap-[24px] items-center justify-end px-[65px] py-[20px] shadow-sm">
      <p 
        ...
        className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#e82ebf] text-[20px] text-nowrap whitespace-pre cursor-pointer hover:underline transition-all"
      >{`About `}</p>
      <Frame2 />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Section Header">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] not-italic relative shrink-0 text-[#172b4d] text-[40px] w-full">Create your own story.</p>
    </div>
  );
}
...
function Section() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[32px] h-[401px] items-start p-[56px] relative rounded-[16px] shrink-0 w-[581px]" data-name="Section">
      <SectionHeader />
      <Alert />
    </div>
  );
...
function Photobooth({ onNavigate }: { onNavigate: (page: string) => void }) {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[20px] h-[282px] items-center justify-center p-[20px] relative rounded-[12px] shrink-0 w-[260px]" data-name="Photobooth">
      <ImageAspectRatio />
...
function Polaroid({ onNavigate }: { onNavigate: (page: string) => void }) {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[20px] items-center justify-center p-[20px] relative rounded-[12px] shrink-0 w-[260px]" data-name="Polaroid">
      <ImageAspectRatio1 />
...
function Frame({ onNavigate }: { onNavigate: (page: string) => void }) {
  return (
    <div className="box-border content-stretch flex gap-[61px] items-center relative shadow-[0px_4px_50px_0px_rgba(0,0,0,0.15)] shrink-0">
...
function Frame3({ onNavigate }: { onNavigate: (page: string) => void }) {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end left-[268px] top-[183px] w-[905px] mt-[80px]">
...
export default function Home({ onNavigate }: HomeProps) {
  return (
    <div className="bg-[#ecebeb] relative size-full" data-name="Home">
